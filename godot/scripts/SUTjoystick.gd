...
# if you don't want the js_maps directory in your project, you can add more json mappings to this array.
	if OS.get_name().to_lower() == 'x11':
		js_maps = [
			...
			{"axis":{"dpad_down":6,"dpad_left":-5,"dpad_right":5,"dpad_up":-6,"leftstick_down":2,"leftstick_left":-1,"leftstick_right":1,"leftstick_up":-2,"rightstick_down":3,"rightstick_left":-4,"rightstick_right":4,"rightstick_up":-3,"trig_left":null,"trig_right":null},"button":{"action_1":2,"action_2":1,"action_3":3,"action_4":0,"back":8,"bump_left":6,"bump_right":7,"click_left":10,"click_right":11,"dpad_down":null,"dpad_left":null,"dpad_right":null,"dpad_up":null,"home":null,"start":9,"trig_left":4,"trig_right":5},"common_name":"PlayStation 2 Plus Adapter","deadzone":0.1,"flight_stick":false,"guitar":false,"md5":"c016fd7e1b5de8315b484106b240b336","name":"Twin USB Joystick","os":"x11","special":false},
